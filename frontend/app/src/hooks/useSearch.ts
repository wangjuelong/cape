...
import { fetchSearch, fetchSearchPrefixes, type SearchPrefix, type SearchResponse } from "@/lib/api/search";
...
export const FALLBACK_SEARCH_PREFIXES: SearchPrefix[] = [
  ...
  { prefix: "options", description: "Task options (e.g., options:function=DllMain)", group: "General & Metadata" },
  { prefix: "tags_tasks", description: "Task tags (e.g., tags_tasks:mytag)", group: "General & Metadata" },
  { prefix: "package", description: "Analysis package (e.g., package:ps1)", group: "General & Metadata" },
  ...
  { prefix: "target_sha256", description: "Target file SHA256", group: "File Properties & Static Analysis" },
  ...
  { prefix: "ssdeep", description: "Fuzzy hash (SSDeep)", group: "File Properties & Static Analysis" },
  ...
  { prefix: "iconhash", description: "Exact icon hash", group: "File Properties & Static Analysis" },
  { prefix: "iconfuzzy", description: "Fuzzy icon hash", group: "File Properties & Static Analysis" },
  { prefix: "dhash", description: "Icon dhash", group: "File Properties & Static Analysis" },
  { prefix: "die", description: "Detect It Easy (DIE) signature (e.g., die:obsidium)", group: "File Properties & Static Analysis" },
  { prefix: "extracted_tool", description: "Extracted tool (e.g., InnoExtract)", group: "File Properties & Static Analysis" },
  { prefix: "virustotal", description: "VirusTotal Detected Name", group: "File Properties & Static Analysis" },
  { prefix: "clamav", description: "Local ClamAV detections", group: "File Properties & Static Analysis" },
  { prefix: "yaraname", description: "Yara Rule Name (binary folder)", group: "File Properties & Static Analysis" },
  { prefix: "capeyara", description: "Yara Rule Name (cape folder)", group: "File Properties & Static Analysis" },
  { prefix: "procdumpyara", description: "Yara Rule Name (process dumps)", group: "File Properties & Static Analysis" },
  { prefix: "procmemyara", description: "Yara Rule Name (memory dumps)", group: "File Properties & Static Analysis" },
  // Network Analysis
  ...
  { prefix: "asn_name", description: "ASN name (e.g., asn_name:Google LLC)", group: "Network Analysis" },
  ...
  { prefix: "suritlsfingerprint", description: "Suricata TLS Fingerprint", group: "Network Analysis" },
  ...
  { prefix: "command", description: "Executed commands matching pattern", group: "Behavior & Execution" },
  { prefix: "resolvedapi", description: "APIs resolved at runtime", group: "Behavior & Execution" },
  { prefix: "key", description: "Open registry keys matching pattern", group: "Behavior & Execution" },
  ...
  { prefix: "signature", description: "CAPE Signature descriptions", group: "Behavior & Execution" },
