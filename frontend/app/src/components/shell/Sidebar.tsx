...
const NAV_ITEMS: NavItem[] = [
  ...
  { to: "/submit", label: "Submit", icon: Icon.upload },
  { to: "/recent", label: "Recent", icon: Icon.list },
  { to: "/pending", label: "Pending", icon: Icon.pulse },
  { to: "/search", label: "Search", icon: Icon.search },
  { to: "/compare", label: "Compare", icon: Icon.diff },
  { to: "/stats", label: "Statistics", icon: Icon.pulse },
];

const ADMIN_ITEMS: NavItem[] = [
  { to: "/machines", label: "Machines", icon: Icon.cog },
